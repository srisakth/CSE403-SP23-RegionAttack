...
public class GameTests
{
    ...
    public void IsValidTestsBasic()
    {
        ...
        Assert.AreEqual(0, game.IsValid((-1,-1), 0, game.isP1Turn));
        Assert.AreEqual(0, game.IsValid((dim, 0), 0, game.isP1Turn));
        Assert.AreEqual(0, game.IsValid((0, dim), 0, game.isP1Turn));
        Assert.AreEqual(0, game.IsValid((dim, dim), 0, game.isP1Turn));

        // Test opponent larger number
        for(int i = 0; i < turns.Length; i++){
            game.board[0,0] = (5,turns[i]);
            game.isP1Turn = !turns[i];
            Assert.AreEqual(-1,game.IsValid((0,0),3, game.isP1Turn));
            game.board[1,1] = (12,turns[i]);
            game.isP1Turn = !turns[i];
            Assert.AreEqual(-1,game.IsValid((1,1),7, game.isP1Turn));
        }
        ...
        for(int i = 0; i < turns.Length; i++){
            ...
            Assert.AreEqual(-2,game.IsValid((1,2),2, game.isP1Turn));
            Assert.AreEqual(-3,game.IsValid((3,1),6, game.isP1Turn));
            Assert.AreEqual(-4,game.IsValid((0,0),2, game.isP1Turn));
            Assert.AreEqual(-5,game.IsValid((4,2),4, game.isP1Turn));
        }
        ...
        for(int i = 0; i < turns.Length; i++){
            ...
            game.board[0,2] = (7,turns[i]);
            game.board[4,3] = (9,turns[i]);
            Assert.AreEqual(2,game.IsValid((1,2),7, game.isP1Turn));
            Assert.AreEqual(3,game.IsValid((3,1),8, game.isP1Turn));
            Assert.AreEqual(4,game.IsValid((0,0),6, game.isP1Turn));
            Assert.AreEqual(5,game.IsValid((4,2),3, game.isP1Turn)); 
        }
        ...
        for(int i = 0; i < primes.Length; i++){
            ...
            Assert.AreEqual(6,game.IsValid((x,y), primes[i], game.isP1Turn));
        }
        game.isP1Turn = false;
        for(int i = 0; i < primes.Length; i++){
            int x = random.Next(0,dim);
        ...
        for(int j = 0; j < turns.Length; j++){
            for(int i = 0; i < nprimes.Length; i++){
                ...
                Assert.AreEqual(-7,game.IsValid((x,y), nprimes[i], game.isP1Turn));
            }
        }
    ...
    public void IsValidTestsAdvanced()
    {
        ...
        game.isP1Turn = true;
        Assert.AreEqual(4,game.IsValid((1,0),4, game.isP1Turn));
        Assert.AreEqual(2,game.IsValid((2,1),8, game.isP1Turn));
        Assert.AreEqual(2,game.IsValid((2,3),12, game.isP1Turn));
        game.isP1Turn = false;
        Assert.AreEqual(2,game.IsValid((4,1),7, game.isP1Turn));
        Assert.AreEqual(3,game.IsValid((3,2),1, game.isP1Turn));
        Assert.AreEqual(3,game.IsValid((4,5),11, game.isP1Turn));
    }
    [Test]
